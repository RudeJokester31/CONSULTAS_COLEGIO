...
const char* ssid[] = {"LAPTOP-TOB1OK0R 5797","ITSA.STAFFv2","CASTRILLON","ITSA.STUDENTSv2", "WENDY" };
const char* password[] = {"12345678a","2017quality.45","DaEMIs753XL@","estA1754*", "1001943165" };
int length;
boolean desconectado = true; 

///Conexion a la Api
//const char* Api_rest = "http://192.168.20.55:5000/create_log_ingresos";
const char* Api_rest = "http://192.168.1.5:5000/registrar_huella";
char jsonOutput[128];
...
void abrirPuerta() {
  Serial.println(" AUTORIZADA *** "+ String(id_u)); 
  ...
  object["ID_USUARIO"] = id_u;
  object["ID_SALON"] = id_s;
